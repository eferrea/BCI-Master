...
uicontrol('Parent',p_perturb,'String','Start','Units','normalized',...
    'Position',[0.01 0.001 0.49 0.2],'callback',@Start_perturbation);

uicontrol('Parent',p_perturb,'String','Stop','Units','normalized',...
...
%         end
    ...
    function Start_perturbation(hObj,event)
        ...
        obj_dec.ResetRotation(reshaped_correlation);
         obj_dec.UpdateRotation(reshaped_correlation,perturbation_vector,perturbation_angle,perturbation_percent);
