...
classdef simNeurons_3D_velocity < handle  % class should be implemented as a handle class. 
    ...
    methods (Access=public)
        ...
        function obj = simNeurons_3D_velocity(N,varargin) %constructor for the class
            % protected memeber
            obj.time = tic;
            obj.start_time = tic;
            % public member
