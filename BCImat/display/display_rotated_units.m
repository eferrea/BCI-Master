...
%It takes the position and length of the table, the table of R2 values from single units, the list of rotated units, and the list of units used for decoding as input
